...
func color(_ hex: UInt32, _ alpha: CGFloat = 1) -> CGColor {
	CGColor(colorSpace: rgb, components: [
...
func draw(into ctx: CGContext) {
	...
	ctx.addPath(body)
	ctx.clip()
	ctx.drawLinearGradient(gradient([(0x5A5F6B, 1, 0), (0x3C4049, 1, 0.55), (0x1E2126, 1, 1)]),
	                       start: CGPoint(x: 0, y: bodyBox.minY),
	                       end: CGPoint(x: 0, y: bodyBox.maxY),
	                       options: [])

	// Heat pooling at the bottom of the body.
	ctx.drawRadialGradient(gradient([(0xFF7A18, 0.30, 0), (0xFF7A18, 0, 1)]),
	...
	ctx.addPath(CGPath(roundedRect: handle, cornerWidth: 27, cornerHeight: 27, transform: nil))
	ctx.clip()
	ctx.drawLinearGradient(gradient([(0xF2F5FA, 1, 0), (0xC2C8D2, 1, 0.5), (0x878E9A, 1, 1)]),
	...
	ctx.addPath(windowPath)
	ctx.clip()
	ctx.drawRadialGradient(gradient([(0xFFC96E, 1, 0), (0xFF8A28, 1, 0.5), (0xE24A0C, 1, 0.82), (0xB22F08, 1, 1)]),
	...
	ctx.drawRadialGradient(gradient([(0x2A0C00, 0, 0), (0x2A0C00, 0, 0.62), (0x2A0C00, 0.45, 1)]),
	...
	ctx.drawLinearGradient(gradient([(0xFFFFFF, 0.32, 0), (0xFFFFFF, 0.05, 0.45), (0xFFFFFF, 0, 0.6)]),
	...
	ctx.addPath(page)
	ctx.clip()
	ctx.drawLinearGradient(gradient([(0xFFFFFF, 1, 0), (0xFFF4E6, 1, 1)]),
